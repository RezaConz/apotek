...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Toko Obat Abadi</strong></a>
    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
            <?php $nomor=1; ?>
            <?php $totalbelanja = 0; ?>
            <?php foreach ($_SESSION["pesanan"] as $id_obat => $jumlah) : ?>

            <?php 
              include('koneksi.php');
              $ambil = mysqli_query($koneksi, "SELECT * FROM obat WHERE id_obat='$id_obat'");
          ...
          <tr>
            ...
            <td>
              <a href="hapus_pesanan.php?id_obat=<?php echo $id_obat ?>" class="badge badge-danger">Hapus</a>
            </td>
          </tr>
            <?php $nomor++; ?>
      ...
      if(isset($_POST['konfirm'])) {
          ...
          foreach ($_SESSION["pesanan"] as $id_obat => $jumlah)
          {
            $insert = mysqli_query($koneksi, "INSERT INTO pemesanan_obat (id_pemesanan, id_obat, jumlah) 
              VALUES ('$id_terbaru', '$id_obat', '$jumlah') ");
          }          
